...
# Powering up
To my surprise, the router had not been reset to a default config before being donated. It was broadcasting a non-defualt SSID, and was not configured with the default credentials.
